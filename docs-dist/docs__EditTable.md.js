      ...
      const n = /^([1-9][0-9]*)(\.[\d]{1,2})?|(0\.[\d]{1,2})$/,
        ...
        s = {
          ...
          amountNumber: (e, t = 6, a = !0) => {
            const n = 6 === t ? r.decimal_amount : r.decimal_price,
              s = l[t],
              c = s.max,
              i = s.message,
              m = [
            ...
            return a && m.unshift({ required: !0, message: '\u8bf7\u8f93\u5165' + e }), m;
          },
          amountPrice(e, t) {
            return this.amountNumber(e, 9, t);
          },
        },
        c = { rules: s, NUMBER: l, regExps: r };
      t['a'] = c;
    },
    'H+Z4': function(e, t, a) {
      'use strict';
        ...
        return l.a.createElement(
          ...
          l.a.createElement(
            ...
            l.a.createElement(
              ...
              l.a.createElement(
                'a',
                { 'aria-hidden': 'true', href: '#edittable' },
          ...
          l.a.createElement(
            ...
            Object(n['a'])(
              ...
              },
              {
                ...
                dependencies: { antd: '4.6.6', lodash: '4.17.20', qbmi: '0.0.20' },
                files: {},
              },
            ),
            ...
            l.a.createElement(
              ...
              l.a.createElement(
                ...
                l.a.createElement(
                  'tr',
                  null,
                  l.a.createElement('td', null, 'ref'),
                  l.a.createElement('td', null, '\u83b7\u53d6\u5f53\u524d\u8282\u70b9'),
                ...
                l.a.createElement(
                  ...
                  l.a.createElement('td', null, '\u6bcf\u4e00\u884c\u7684\u552f\u4e00 key.'),
                  l.a.createElement('td', null, '------'),
                  l.a.createElement('td', null, '-'),
                ),
                l.a.createElement(
                  'tr',
                  null,
                  l.a.createElement('td', null, 'hasDelete'),
                  l.a.createElement(
                    'td',
                    null,
                    '\u662f\u5426\u652f\u6301\u5220\u9664\u884c\u7684\u64cd\u4f5c.',
                ...
                l.a.createElement(
                  ...
                  l.a.createElement('td', null, '\u8868\u683c\u5185\u5bb9\u6570\u636e\u6e90.'),
                  l.a.createElement('td', null, 'array'),
                  l.a.createElement('td', null, '[]'),
                ),
                l.a.createElement(
                  'tr',
                  null,
                  l.a.createElement('td', null, 'dataSourceChange'),
                  l.a.createElement(
                    'td',
                    null,
                    '\u8868\u683c\u6570\u636e\u53d1\u751f\u53d8\u5316\u7684\u56de\u8c03\u51fd\u6570\uff0c\u8fd4\u56de\u53d8\u5316\u4e4b\u540e\u7684 dataSource.',
                  ),
                  l.a.createElement('td', null, 'array'),
                  l.a.createElement('td', null, '[]'),
                ),
                l.a.createElement(
                  'tr',
                  null,
                  l.a.createElement('td', null, 'pagination'),
                  l.a.createElement(
                    'td',
                    null,
                    '\u5206\u9875\u5668\uff0c\u4e0e antd \u4e00\u81f4\uff0c\u5177\u4f53\u53c2\u8003',
                    l.a.createElement(
                      'a',
                      {
                        href: 'https://ant.design/components/pagination-cn/#API',
                        target: '_blank',
                        rel: 'noopener noreferrer',
                      },
    ...
    KTev: function(e, t, a) {
      ...
      const h = m['a'].NUMBER,
        ...
        E = e => {
          const t = e.decimal,
            ...
            x = Object(l['useState'])(d),
            v = Object(i['a'])(x, 2),
            w = v[0],
            y = v[1],
            S = 'price' === m ? a : void 0 !== o ? o : t,
            C = h[f[m]].max;
          Object(l['useEffect'])(() => {
            y(d);
          }, [d]);
          const N = t => {
            const a = e.onChange,
              n = t.target.value;
            if (n) {
              const e = Math.min(Number(n), C).toFixed(S);
              y(e), a && a(e), g && g(t);
            }
          };
          return s.a.createElement(
            ...
            s.a.createElement(
              p['a'],
              Object(n['a'])(
                { type: 'number', value: w, min: E, max: C, onBlur: N, style: { width: '100%' } },
                b,
                { className: 'searchForm-field' },
              ),
            ),
      ...
      const b = e => {
        const t = e.prefix,
          ...
          l = e.suffix,
          c = void 0 === l ? '' : l,
          i = Object(r['a'])(e, ['prefix', 'suffix']);
        return s.a.createElement(
          s.a.Fragment,
          null,
          void 0 !== c || void 0 !== a
            ? s.a.createElement(g, Object(n['a'])({ suffix: c, prefix: a }, i))
      ...
      const v = {
        ...
        w = e => {
          const t = e.decimal,
            a = void 0 === t ? 2 : t,
            m = e.value,
            o = Object(r['a'])(e, ['decimal', 'value']),
            d = Object(l['useState'])(0.1),
            u = Object(i['a'])(d, 2),
            p = u[0],
            h = u[1],
            f = () => {
    ...
    'SL+x': function(e, t, a) {
      ...
      const f = e => {
        ...
        g = ({ index: e, ...t }) => {
          ...
          return l.a.createElement(
            d['a'],
            { form: r, onValuesChange: s, component: !1 },
            l.a.createElement(E.Provider, { value: r }, l.a.createElement('tr', t)),
          );
        },
        b = ({
          title: e,
          ...
          const p = Object(r['useContext'])(E);
          let h = a;
          if (t) {
            const e = `${n}_[${s.key}]`;
            o && o({ key: s.key, form: p }),
              Object(r['useEffect'])(() => {
                t && p.setFieldsValue({ [e]: s[n] });
              }, []),
              (h = l.a.createElement(
                d['a'].Item,
          ...
          return l.a.createElement('td', u, h);
        };
      class x extends l.a.Component {
        static getDerivedStateFromProps(e, t) {
          ...
          return (
            ...
            n && n !== t.dataSource && (r.dataSource = n),
            r
          );
        }
        constructor(e) {
          super(e),
            ...
            (this.handleAdd = () => {
              const e = this.props.dataSourceChange,
                ...
                l = Object.assign({ key: new Date().getTime().toString() }, r);
              e && e({ list: [...n, l] });
            }),
            (this.handleDelete = e => {
            ...
            (this.handleSave = e => {
              const t = this.props.dataSourceChange,
                ...
                n = a.findIndex(t => t.key == e.key),
                r = a[n];
              a.splice(n, 1, { ...r, ...f(e) }), t && t({ list: a });
            }),
              ...
              e => (
                'string' === typeof e.title &&
                  ...
                  (e.title = l.a.createElement(
                    ...
                    l.a.createElement('label', { className: 'ant-form-item-required' }, e.title),
                  )),
                e
              ),
            );
                ...
                u.length <= 1
                  ...
                  ? (e, t) =>
                      l.a.createElement(
                        ...
                        l.a.createElement('a', { className: 'text-error' }, '\u5220\u9664'),
                      )
                  : (e, t) =>
                      l.a.createElement(
                        'a',
          ...
          return l.a.createElement(
            ...
            t &&
              l.a.createElement(
                ...
                {
                  type: 'dashed',
                  icon: l.a.createElement(p['a'], null),
      ...
      x.defaultProps = { isShowAdd: !0 };
      var v = x;
      const w = s['a'].InputNumber;
