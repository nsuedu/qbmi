...
var Select = /*#__PURE__*/function (_React$Component) {
  ...
  function Select(props) {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                if (Array.isArray(res)) {
                  ...
                  _newDatas = isFunction(dataHandler) ? dataHandler(res.dataSource) : res.dataSource;

                  _this.setState(function (prev) {
                    return {
                      options: uniqBy([].concat(_newDatas, prev.options), 'value'),
                      fetching: false,
    ...
    _this.handleSearch = debounce(_this.handleSearch, 400);
    _this.state = {
