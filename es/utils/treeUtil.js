...
// 数组扁平化  树形数组转化为一维数组
export var generateList = function generateList(data, dataList) {
...
export var arrayToTree = function arrayToTree(datas) {
...
export var getLastChildren = function getLastChildren(treeData, result) {
...
export var getDataByKeyFromTreeData = function getDataByKeyFromTreeData(params) {
  var key = params.key,
...
export var getParentInfoByKey = function getParentInfoByKey(key, tree) {
  var parentInfo;
...
export var transformTree = function transformTree(obj) {
...
export var dataTransformToTree = function dataTransformToTree(obj) {
  var originData = obj.originData,
