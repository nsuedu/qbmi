  ...
  _createClass(StandardTable, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["data", "loading", "columns", "rowKey", "hasRowSelection", "scroll", "title", "rowSelection", "alertProps", "size", "locale", "rowClassName", "className", "tableLayout", "footer", "bordered"]); // 分页设置,设为false则取消分页选项
      ...
      pagination && _objectSpread(_objectSpread({
        ...
        showTotal: function showTotal() {
          return "\u603B\u5171".concat(pagination && pagination.totalRecords ? pagination.totalRecords : 0, "\u6761");
        }
      }) || false; // checkbox功能配置
      ...
      React.createElement("div", {
        ...
        ,
        dataSource: list.map(function (item) {
          item.pagination = paginationProps;
          return item;
        }) // 表格列配置
        ,
        ...
        locale: locale,
        className: bordered ? undefined : "table-striped".concat(className ? " ".concat(className) : ''),
        footer: footer
      }, rest)));
    }
  }]);
