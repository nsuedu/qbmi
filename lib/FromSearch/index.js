...
var _custTreeSelect = _interopRequireDefault(require("@/components/base/custTreeSelect"));

var _lodash = require("lodash");

var _moment = _interopRequireDefault(require("moment"));

var _Select2 = _interopRequireDefault(require("@/components/base/Select"));
...
var StandardForm = function StandardForm(props) {
  ...
  var renderRadio = function renderRadio(list) {
    return list.map(function (item) {
  ...
  var renderItems = function renderItems(item) {
    ...
    switch (item.type) {
      case 'myselect':
        FormItem = /*#__PURE__*/_react.default.createElement(_Select2.default, {
      ...
      case 'select':
        FormItem = /*#__PURE__*/_react.default.createElement(_Select2.default, {
          ...
          dataServer: function dataServer(val) {
            if (typeof item.requestType === 'string') {
              return (0, _selectRequestUtils.requestData)({
                requestType: item.requestType,
                params: _objectSpread(_objectSpread({}, val), item.requestParams)
              });
            }
      ...
      case 'custTreeSelect':
        FormItem = /*#__PURE__*/_react.default.createElement(_custTreeSelect.default, {
          allowClear: true,
          dataServer: item.dataServer,
  ...
  var renderRow = function renderRow(list) {
    ...
    var fieldsArr = Array.isArray(list) ? _.flatMap(list, function (item) {
      return item;
    }) : [];
