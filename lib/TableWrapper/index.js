...
var TableList = /*#__PURE__*/function (_Component) {
  ...
  function TableList(props) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              lataestParams = (0, _lodash.isFunction)(paramsHandler) ? paramsHandler(postData) : postData;
              _context.next = 6;
    ...
    _this.renderTable = function () {
      ...
      return /*#__PURE__*/_react.default.createElement("div", null, formOptions && /*#__PURE__*/_react.default.createElement(_StandardForm.default, {
      ...
      }), children, /*#__PURE__*/_react.default.createElement(_StandardTable.default, _extends({
        rowKey: "id"
      }, newTableProps, {
  ...
  _createClass(TableList, [{
    ...
    value: function componentDidMount() {
      ...
      if ((0, _lodash.isFunction)(tableWrapperRef)) {
    ...
    value: function componentDidUpdate(prevState) {
      ...
      if (thisSearchParams && !(0, _lodash.isEqual)(thisSearchParams, preSearchParams)) {
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      if (nextProps.searchParams && !(0, _lodash.isEqual)(searchParams, prevState.searchParams)) {
...
TableList.propTypes = {
  ...
  // 默认查询条件
  searchParams: _propTypes.default.object,
  // 表格改变事件
  handleTableChange: _propTypes.default.func,
  handleMenuClick: _propTypes.default.func,
  sortOrder: _propTypes.default.string,
  handleSelectRows: _propTypes.default.func,
  // 在Alert中是否显示总计
  alertProps: _propTypes.default.object,
  // scroll: PropTypes.object,
  listService: _propTypes.default.func.isRequired,
  formValuesChange: _propTypes.default.func,
  // eslint-disable-next-line react/require-default-props
  onFormReset: _propTypes.default.func
};
