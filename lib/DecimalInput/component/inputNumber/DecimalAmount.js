...
var NUMBER = _RegExp.default.NUMBER;
...
var DecimalAmount = function DecimalAmount(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_inputNumber.default, _extends({
    value: value,
    min: 0,
    max: NUMBER['6'].max,
    step: fixed,
